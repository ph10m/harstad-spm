...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "--rot", /*rotation*/ ctx[0] + "deg");
    			attr_dev(div, "class", "svelte-13t70ib");
    			add_location(div, file$1, 50, 2, 1315);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*degrees, Colors, triangleWidth, triangleHeight*/ 208) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "--width", /*trianglePx*/ ctx[5]);
    			attr_dev(div, "class", "svelte-13t70ib");
    			add_location(div, file$1, 33, 2, 926);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!div_intro) div_intro = create_in_transition(div, /*spin*/ ctx[3], {
    					duration: (/*timer*/ ctx[2] + 0.5) * 1000
    				});
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(56:4) {#each Questions as _, i}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:4) {#each Questions as _, i}",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["rotation", "active", "timer"];
    ...
    class RotatingWheel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { rotation: 0, active: 1, timer: 2 });
    		...
    		if (/*rotation*/ ctx[0] === undefined && !("rotation" in props)) {
    		...
    		if (/*timer*/ ctx[2] === undefined && !("timer" in props)) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(t2_value);
    			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(`ticker ${/*spinning*/ ctx[3] && "spinning-ticker"}`) + " svelte-1689a4"));
    			add_location(div0, file, 62, 6, 1995);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(`spin-button ${/*spinning*/ ctx[3] && "disabled"}`) + " svelte-1689a4"));
    			add_location(div1, file, 68, 6, 2187);
    			attr_dev(div2, "class", "svelte-1689a4");
    			add_location(div2, file, 61, 4, 1929);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty & /*spinning*/ 8 && div0_class_value !== (div0_class_value = "" + (null_to_empty(`ticker ${/*spinning*/ ctx[3] && "spinning-ticker"}`) + " svelte-1689a4"))) {
    			...
    			if (dirty & /*animationTimer*/ 4) rotatingwheel_changes.timer = /*animationTimer*/ ctx[2];
    			...
    			if (!current || dirty & /*spinning*/ 8 && div1_class_value !== (div1_class_value = "" + (null_to_empty(`spin-button ${/*spinning*/ ctx[3] && "disabled"}`) + " svelte-1689a4"))) {
    ...
    // (45:2) {#if (questionBoxOpen)}
    function create_if_block(ctx) {
    	let div1;
    	let div0;
    	let t1;
    	let p;
    	let t2_value = Questions[/*landingQuestion*/ ctx[4]].text + "";
    	let t2;
    	let div1_transition;
    	let current;
    	let mounted;
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t2 = text(t2_value);
    			attr_dev(div0, "class", "question-box-closer svelte-1689a4");
    			add_location(div0, file, 55, 6, 1761);
    			attr_dev(p, "class", "svelte-1689a4");
    			add_location(p, file, 58, 6, 1860);
    			attr_dev(div1, "class", "question-box svelte-1689a4");
    			set_style(div1, "background-color", Colors[/*landingQuestion*/ ctx[4]]);
    			add_location(div1, file, 45, 4, 1518);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    			...
    			if (!mounted) {
    				dispose = listen_dev(div0, "click", /*onOpenQuestion*/ ctx[6], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*landingQuestion*/ 16) && t2_value !== (t2_value = Questions[/*landingQuestion*/ ctx[4]].text + "")) set_data_dev(t2, t2_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(45:2) {#if (questionBoxOpen)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			if_block.c();
    			attr_dev(div, "class", "bg-image svelte-1689a4");
    			add_location(div, file, 38, 0, 1253);
    			attr_dev(link, "href", "//maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css");
    			attr_dev(link, "rel", "stylesheet");
    			attr_dev(link, "class", "svelte-1689a4");
    			add_location(link, file, 43, 2, 1385);
    			set_style(main, "--timer", /*animationTimer*/ ctx[2] + timerDelay + "s");
    			set_style(main, "--triangleHeight", `${/*triangleHeight*/ ctx[7]}px`);
    			attr_dev(main, "class", "svelte-1689a4");
    			add_location(main, file, 39, 0, 1278);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*animationTimer*/ 4) {
    				set_style(main, "--timer", /*animationTimer*/ ctx[2] + timerDelay + "s");
    			}
    		},
    		i: function intro(local) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const onSpin = () => {
    		$$invalidate(2, animationTimer = random(4, 6));
    		...
    		setTimeout(() => $$invalidate(0, questionBoxOpen = true), animationTimer * 1000);
    		setTimeout(() => $$invalidate(3, spinning = false), (timerDelay + animationTimer) * 1000);
    	};

    	const onOpenQuestion = () => {
    		$$invalidate(0, questionBoxOpen = false);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("animationTimer" in $$props) $$invalidate(2, animationTimer = $$props.animationTimer);
